...
var GridItem = function (_React$Component) {
  ...
  GridItem.prototype.calcColWidth = function calcColWidth() {
    ...
    var relatedContainerWidth = containerWidth;
    // If relative to viewport, calculate the colWidth based on a relative containerWidth
    if ((0, _utils.isUnitRelative)(unit)) {
      var viewPortSize = (0, _utils.getViewportSize)(unit);
  ...
  GridItem.prototype.createStyle = function createStyle(pos) {
    ...
    if (useCSSTransforms) {
      style = (0, _utils.setTransform)(pos, this.props.unit);
    }
    // top,left (slow)
    else {
        style = (0, _utils.setTopLeft)(pos, this.props.unit);
